 ...
 *   !proto.Empty>}
 */
const methodDescriptor_ChatService_isUserTyping = new grpc.web.MethodDescriptor(
  '/ChatService/isUserTyping',
  grpc.web.MethodType.UNARY,
  proto.ChatMessage,
  proto.Empty,
  /**
 ...
 *     The XHR Node Readable Stream
 */
proto.ChatServiceClient.prototype.isUserTyping =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/ChatService/isUserTyping',
      request,
      metadata || {},
      methodDescriptor_ChatService_isUserTyping,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.ChatServicePromiseClient.prototype.isUserTyping =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/ChatService/isUserTyping',
      request,
 ...
 *   !proto.ChatMessage>}
 */
const methodDescriptor_ChatService_receiveIsUserTyping = new grpc.web.MethodDescriptor(
  '/ChatService/receiveIsUserTyping',
  grpc.web.MethodType.SERVER_STREAMING,
  proto.Empty,
  proto.ChatMessage,
  /**
 ...
 *     The XHR Node Readable Stream
 */
proto.ChatServiceClient.prototype.receiveIsUserTyping =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/ChatService/receiveIsUserTyping',
      request,
      metadata || {},
      methodDescriptor_ChatService_receiveIsUserTyping);
};
 ...
 *     The XHR Node Readable Stream
 */
proto.ChatServicePromiseClient.prototype.receiveIsUserTyping =
    function(request, metadata) {
  return this.client_.serverStreaming(this.hostname_ +
      '/ChatService/receiveIsUserTyping',
      request,
